...
import compliance.PageObjMethods.Data_Retention;

public class DataRetention extends testBase{
...
//		ExcelOp.loadExcel("Testdata");
	...
	public void dataRetention() throws InterruptedException, IOException {
		CommonMethods commonMethods = PageFactory.initElements(driver, CommonMethods.class);
		Data_Retention login = PageFactory.initElements(driver, Data_Retention.class);
