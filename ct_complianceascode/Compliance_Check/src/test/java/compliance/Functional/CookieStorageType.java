...
public class CookieStorageType extends testBase{
	...
	public void cookieStorageType() throws InterruptedException, IOException {
		CommonMethods commonMethods = PageFactory.initElements(driver, CommonMethods.class);
		Cookie_StorageType check = PageFactory.initElements(driver, Cookie_StorageType.class);
