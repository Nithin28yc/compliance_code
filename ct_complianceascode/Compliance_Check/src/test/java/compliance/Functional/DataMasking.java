...
import compliance.PageObjMethods.Data_Masking;

public class DataMasking extends testBase{
...
//		ExcelOp.loadExcel("Testdata");
	...
	public void dataMasking() throws InterruptedException, IOException {
		CommonMethods commonMethods = PageFactory.initElements(driver, CommonMethods.class);
		Data_Masking login = PageFactory.initElements(driver, Data_Masking.class);
