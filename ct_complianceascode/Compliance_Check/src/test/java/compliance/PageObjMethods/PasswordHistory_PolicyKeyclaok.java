...
public class PasswordHistory_PolicyKeyclaok extends testBase{
	...
	public void passwordChange(String ldapuname, String ldapEmail, String ldapPass, String newPassword) throws InterruptedException {
		commonMethods.waitForPageToLoad();
...
//						incrtBtn.click();
			...
			logger.log(LogStatus.INFO, "Not able to change password");
