...
public class Least_Privilege extends testBase{
	...
	@FindBy(xpath = "//*[@id=\"addLdapUserModal\"]/div[2]/div/form/div[2]/div[3]/div[1]/div")
	...
	public boolean addingLdapUser(String username,String password,String ldapuname, String ldapEmail) throws InterruptedException {
		...
		try {
			...
			logger.log(LogStatus.PASS, "Giving only least privilege for the user");
			System.out.println("Giving only least privilege for the user");
			people.click();
			return true;
