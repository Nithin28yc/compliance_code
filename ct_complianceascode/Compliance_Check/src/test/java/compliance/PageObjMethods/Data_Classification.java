...
public class Data_Classification extends testBase{
	...
	public boolean devOpsPlatformLogin(String username,String password) throws InterruptedException {
		...
		try {
			...
			try {
				...
				//				if(heading.getText().equals("Confidential Information – Reminder")) {
				...
				logger.log(LogStatus.FAIL, "Confedential Information - Reminder poup is not coming as a part of Data clasification");
				System.out.println("Confedential Information - Reminder poup is not coming as a part of Data clasification");
				return false;
			}
